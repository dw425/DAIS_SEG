"""Azure Data Factory to Databricks mapper."""
...
_YAML_PATH = Path(__file__).parent.parent.parent / "constants" / "processor_maps" / "azure_adf_databricks.yaml"
