...
_YAML_PATH = Path(__file__).parent.parent.parent / "constants" / "processor_maps" / "pentaho_databricks.yaml"
        ...
        if e:
            ...
            m.append(
                MappingEntry(
                    ...
                    mapped=False,
                    confidence=0.0,
                    code=f"# UNMAPPED: Pentaho {p.type}",
