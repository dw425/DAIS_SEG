"""Snowflake to Databricks mapper."""
...
_YAML_PATH = Path(__file__).parent.parent.parent / "constants" / "processor_maps" / "snowflake_databricks.yaml"
        ...
        if e:
            ...
            m.append(
                MappingEntry(
                    ...
                    mapped=False,
                    confidence=0.0,
                    code=f"# UNMAPPED: Snowflake {p.type}",
